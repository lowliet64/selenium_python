...
def bypass(sitekey, host,proxy, s):
    try :
        ...
        if "generated_pass_UUID" in res:
            ...
            print("[!] Bypassed captcha! ({}...)".format(captcha[:30]))
            return captcha
        else:
            return False
    except : return False
...
if __name__ == '__main__':
	print(bypass("f5561ba9-8f1e-40ca-9b5b-a0b3f719ef34", "discord.com", 'ca8jmszz7mflb00:VA71WECdzgcQrHb7@residential.proxyscrape.com:8080', 's'))